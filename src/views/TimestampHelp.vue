<template>
    <my-page title="时间戳转换 - 帮助" backable>
        <div class="common-container container">
            <ui-article>
                <h2>关于 Unix 时间戳（Unix timestamp）</h2>
                ...
                <table>
                    <tbody><tr style="height:30px;">
                        ...
                        <td><code>(int) (System.currentTimeMillis() / 1000)</code></td>
                    </tr>
                    <tr style="height:30px;">
                        <td>JavaScript</td>
                        <td><code>Math.round(new Date().getTime() / 1000)</code></td>
                    </tr>
                    <tr style="height:30px;">
                    ...
                    <tr style="height:30px;">
                        <td>Python</td>
                        <td><code>先 import time 然后 time.time()</code></td>
                    </tr>
                    <tr style="height:30px;">
                        <td>Ruby</td>
                        <td>获取Unix时间戳：Time.now 或 Time.new<br>显示Unix时间戳：Time.now.to_i</td>
                    </tr>
                    <tr style="height:30px;">
                        <td>SQL Server</td>
